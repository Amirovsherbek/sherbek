                    ...
                    <div className="about_card">
                      <div className="card w-100">
                           <div className="card-header d-flex">
                               ...
                               <div className="card-title w-70  ">
                                  <div>Gulsevar Usmonova</div>
                                </div>
                           </div>
                            <div className="card-body">
                                 <div className='card-text'>Bu kurslar menga juda yoqdi. Barchaga sotib olishni
                                    maslahat beraman.Registon IT School
                                   juda sifatli o’quv markaz deb bilaman men.
                                 </div>
                            </div>
                      </div> 
                    </div>
